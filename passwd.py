# I MODIFIED THIS TOOL TO MAKE YOU MORE INTRACT. CREDITS FOR THIS TOOL AUTHOR
# DICTIONARY ATTACK
# PASSWED GENERATOR
...
def print_cow():
    ...
    print("        MODERN KEYLOGHER       ")

def version():
    """Display version"""

    print("\r\n	\033[1;31m[ passlistgenerator.py ]  " + __version__ + "\033[1;m\r\n")
    print("	* Hacked up by j0rgan - j0rgan@remote-exploit.org")
    print("	* www.muhilmodernkeylogher,tk ")
    print("	Take a look ./README.md for more info ")
...
def improve_dictionary(file_to_open):
    ...
    if leetmode == "y":
        for (
            ...
            unique_lista
        ):  # if you want to add more leet chars, you will need to add more lines in passwd.cfg too...
